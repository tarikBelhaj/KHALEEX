    ...
    <div className="fixed inset-0 bg-black/60 z-50 flex flex-col justify-end animate-fade-in">
      <div className="bg-white dark:bg-gray-800 rounded-t-2xl shadow-2xl w-full max-w-md mx-auto flex flex-col" style={{ height: '85vh' }}>
        <header className="flex items-center justify-between p-4 border-b dark:border-gray-700 flex-shrink-0">
          <h2 className="font-bold text-xl text-gray-800 dark:text-gray-100">{t('filters')}</h2>
        ...
        <main className="p-4 overflow-y-auto flex-grow space-y-6">
            {/* Price Filter */}
            <section>
                <h3 className="font-semibold text-lg text-gray-800 dark:text-gray-200 mb-3">{t('maxPricePerNight')}</h3>
                <div className="px-2">
                    <input
                        type="range"
                        min="500"
            ...
            {/* Rating Filter */}
            <section>
                <h3 className="font-semibold text-lg text-gray-800 dark:text-gray-200 mb-3">{t('stars')}</h3>
            ...
            {/* Amenities Filter */}
            <section>
                <h3 className="font-semibold text-lg text-gray-800 dark:text-gray-200 mb-3">{t('amenities')}</h3>
