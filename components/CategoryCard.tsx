...
export const CategoryCard: React.FC<CategoryCardProps> = ({ category, onClick }) => {
  ...
  return (
    <button onClick={() => onClick(page)} className="relative w-full h-36 rounded-2xl overflow-hidden shadow-lg text-white text-left focus:outline-none focus:ring-4 focus:ring-amber-400 focus:ring-opacity-50 transition-transform duration-200 hover:scale-105">
      ...
      <div className="relative z-10 p-2.5 flex flex-col h-full justify-end">
