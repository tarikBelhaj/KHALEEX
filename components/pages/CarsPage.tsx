        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
            ...
            <div className="flex gap-3 w-full md:w-auto">
                <button 
                    ...
                    className="p-3 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-xl flex-shrink-0 flex-1 md:flex-none justify-center flex hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors"
