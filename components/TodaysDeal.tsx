...
const DealCardSkeleton: React.FC = () => (
    <div aria-hidden="true" className="relative w-48 h-60 flex-shrink-0 rounded-2xl bg-gray-200 dark:bg-gray-700 animate-pulse"></div>
);
...
export const TodaysDeal: React.FC<TodaysDealProps> = ({ onNavigate }) => {
    ...
    const renderContent = () => {
        ...
        if (error) {
            return (
                <div className="flex items-center justify-center w-full h-60 bg-red-50 dark:bg-red-900/20 p-4 rounded-lg text-red-700 dark:text-red-300">
        ...
        if (deals.length === 0) {
             return (
                <div className="flex items-center justify-center w-full h-60 bg-gray-100 dark:bg-gray-800 p-4 rounded-lg text-gray-500 dark:text-gray-400">
        ...
        return deals.map((deal) => (
            <button 
                ...
                className="relative w-48 h-60 flex-shrink-0 rounded-2xl overflow-hidden shadow-lg text-white text-left focus:outline-none focus:ring-4 focus:ring-amber-400 focus:ring-opacity-50 transition-transform duration-200 hover:scale-105 disabled:cursor-not-allowed disabled:hover:scale-100"
            >
                ...
                <div className="relative z-10 p-3 flex flex-col h-full justify-end">
                    <h3 className="font-bold leading-tight">{deal.title}</h3>
        ...
        <section aria-labelledby="todays-deals-heading">
            <div className="flex justify-between items-center mb-4">
                ...
                <button 
                    ...
                    className="text-sm font-semibold text-gray-500 dark:text-gray-400 flex items-center gap-1"
                >
